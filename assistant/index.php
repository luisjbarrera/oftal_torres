                ...
                <td colspan="4">
                    ...
                    <center>
                        <table class="filter-container" style="border: none;" border="0">
                            <tr>
                                <td colspan="4">
                                    <p style="font-size: 20px;font-weight:600;padding-left: 12px;">Recumen</p>
                                </td>
                            </tr>
                            <tr>
                                <td style="width: 25%;">
                ...
                <td colspan="4">
                    <table width="100%" border="0" class="dashbord-tables">
                        <tr>
                            <td>
                                <p style="padding:10px;padding-left:48px;padding-bottom:0;font-size:23px;font-weight:700;color:var(--primarycolor);">
                                    Próximas citas hasta el <?php
                                                                    echo strftime("%A", strtotime("+1 week"));
                                                                    ?>
                                </p>
                                <p style="padding-bottom:19px;padding-left:50px;font-size:15px;font-weight:500;color:#212529e3;line-height: 20px;">
                                    Acceso rápido a las citas de los siguientes 7 días<br>
                                    Más detalles disponibles en la sección de <code>@Citas</code>.
                                </p>
                            ...
                            <td>
                                ...
                                <p style="padding-bottom:19px;text-align:right;padding-right:50px;font-size:15px;font-weight:500;color:#212529e3;line-height: 20px;">
                                    Acceso rápido a las próximas sesiones para los siguientes 7 días<br>
                                    Agrega, quita y otras funciones disponibles en la sección <code>@Calendario.</code>
                                </p>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <center>
                                    <a href="schedule.php" class="non-style-link"><button class="btn-primary btn" style="width:85%">Mostrar toda mi programación</button></a>
                                </center>
                            </td>
                        </tr>
                    </table>
