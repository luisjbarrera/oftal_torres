        ...
        <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
            ...
            <tr>
                <td colspan="2" style="padding-top:30px;">
                    <p class="heading-main12" style="margin-left: 45px;font-size:20px;color:rgb(49, 49, 49)">Agregar Nuevo M&eacute;dico</p>
                </td>
                <td colspan="2">
            ...
            <tr>
                <td colspan="4" style="padding-top:10px;">
                    <p class="heading-main12" style="margin-left: 45px;font-size:18px;color:rgb(49, 49, 49)">M&eacute;dicos (<?php echo $list11->num_rows; ?>)</p>
                </td>
                        ...
                        <div class="abc scroll">
                            <table width="93%" class="sub-table scrolldown" border="0">
                                ...
                                <tbody>
                                    ...
                                    <a class="non-style-link" href="doctors.php"><button  class="login-btn btn-primary-soft btn"  style="display: flex;justify-content: center;align-items: center;margin-left:20px;">&nbsp; Mostrar todos los Médicos &nbsp;</font></button>
                                    </a>
                                    </center>
                                    <br><br><br><br>
                                    </td>
    ...
    if ($_GET) {
        ...
        if ($action == 'drop') {
            ...
            $errorlist = array(
                ...
                '2' => '<label for="promter" class="form-label" style="color:rgb(255, 62, 62);text-align:center;">¡Error de conformación de contraseña! Vuelve e intentarlo</label>',
            ...
            <div id="popup1" class="overlay">
                    ...
                    . '</td>
                            ...
                            <tr>
                                <td>
                                    <p style="padding: 0;margin: 0;text-align: left;font-size: 25px;font-weight: 500;">Agregar Nuevo M&eacute;dico.</p><br><br>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <input type="text" name="name" class="input-text" placeholder="Nombre del M&eacute;dico" required><br>
                                </td>
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <input type="email" name="email" class="input-text" placeholder="Correo electr&oacute;nico" required><br>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
        ...
        ';
            ...
            $errorlist = array(
                '1' => '<label for="promter" class="form-label" style="color:rgb(255, 62, 62);text-align:center;">Ya tengo una cuenta para esta dirección de correo electrónico.</label>',
                '2' => '<label for="promter" class="form-label" style="color:rgb(255, 62, 62);text-align:center;">¡Error de conformación de contraseña! Vuelve a intentarlo</label>',
                '3' => '<label for="promter" class="form-label" style="color:rgb(255, 62, 62);text-align:center;"></label>',
                '4' => "",
                '0' => '',
            ...
            if ($error_1 != '4') {
                echo '
                    ...
                    . '</td>
                                    ...
                                    <tr>
                                        <td>
                                            <p style="padding: 0;margin: 0;text-align: left;font-size: 25px;font-weight: 500;">Editar Información del M&eacute;dico</p>
                                        Nro de Registro : 00' . $id . ' (Auto Generado)<br><br>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="label-td" colspan="2">
