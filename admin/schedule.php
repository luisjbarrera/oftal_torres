        ...
        <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
            ...
            <tr>
                <td colspan="4">
                    <div style="display: flex;margin-top: 40px;">
                        ...
                        <a href="?action=add-session&id=none&error=0" class="non-style-link"><button class="login-btn btn-primary btn button-icon" style="margin-left:25px;background-image: url('../img/icons/add.svg');">Programar médico</font></button>
                        </a>
                    </div>
                </td>
            </tr>
            <tr>
                <td colspan="4" style="padding-top:10px;width: 100%;">
                    ...
                    <p class="heading-main12" style="margin-left: 45px;font-size:18px;color:rgb(49, 49, 49)">Total de programaciones(<?php echo $list110->num_rows; ?>)</p>
                </td>
                ...
                . '</td>
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    ...
                                    <input type="hidden" name="nTypeRegist" value="0">
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td colspan="2">
                                    ...
                                    <input type="submit" value="Programar cita" class="login-btn btn-primary btn" name="shedulesubmit">
                                </td>
