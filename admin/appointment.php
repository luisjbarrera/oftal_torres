                    ...
                    <td width="15%">
                        ...
                        <p class="heading-sub12" style="padding: 0;margin: 0;">
                            <?php
                                ...
                                $today = date('Y-m-d');
                                echo $today;
                                $list110 = $database->query("SELECT * FROM appointment WHERE appodate = CURDATE();");
                            ?>
                        </p>
                    </td>
                    <td width="10%">
                                ...
                                <table width="93%" class="sub-table scrolldown" border="0">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="table-headin">Nombre Sesión</th>
                                            <th class="table-headin" style="font-size:10px">Fecha y hora de la sesión</th>
                                            <th class="table-headin">Fecha de la Cita</th>
                                            <th class="table-headin">Eventos
                                        </tr>
                                    </thead>
                                    <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td style="text-align:center;font-size:23px;font-weight:500; color: var(--btnnicetext);">
                                                            <?php echo substr($apponum, 0, 3); ?>
                                                        </td>
                                                        <td>
                                                            <?php echo substr($docname, 0, 25); ?>
                                                        </td>
                                                        <td>
                                                            <?php echo substr($title, 0, 15); ?>
                                                        </td>
                                                        <td style="text-align:center;font-size:12px;">
                                                            <?php echo substr($scheduledate, 0, 10) . ' <br>' . substr($scheduletime, 0, 5); ?>
                                                        </td>
                                                        ...
                                                        <td>
                                                            <div style="display:flex;justify-content: center;">
                                                                 <a href="?action=drop&id=<?php echo $appoid; ?>&name=<?php echo $pname; ?>&session=<?php echo $title; ?>&apponum=<?php echo $apponum; ?>" class="non-style-link"><button class="btn-primary-soft btn button-icon btn-delete" style="padding-left: 40px;padding-top: 12px;padding-bottom: 12px;margin-top: 10px;"><font class="tn-in-text">Cancelar</font></button></a>
                                                                &nbsp;&nbsp;&nbsp;
                                                            </div>
                                                        </td>
                                                    </tr>
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <div class="content">
                            ...
                            Nombre Paciente &nbsp;<b>' . $nameget. '</b><br>
                            Número de cita &nbsp; : <b>' . $apponum. '</b><br><br>
