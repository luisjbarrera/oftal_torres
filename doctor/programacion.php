                ...
                <div class="dash-body" style="margin-top: 15px">
                    <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;">
                        <tr>
                            ...
                            <td width="25%">
                                <p style="font-size: 23px;padding-left:12px;font-weight: 600;">Ver mi Programaci&oacute;n</p>
                            </td>
                            <td width="15%">
                        ...
                        <tr>
                            <td colspan="4" style="padding-top:10px;width: 100%;">
                                <p class="heading-main12" style="margin-left: 45px;font-size:18px;color:rgb(49, 49, 49)">Mi Programación (<?php echo $list110->num_rows; ?>) </p>
                            </td>
                        </tr>
                        <tr>
                                        ...
                                        <table width="93%" class="sub-table scrolldown" border="0">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="table-headin">Fecha y Hora Cita</th>
                                                    <th class="table-headin">N&deg; reservas</th>
