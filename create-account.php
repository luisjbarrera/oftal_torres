    ...
    if ($_POST) {
        ...
        if ($newpassword == $cpassword) {
            ...
            if ($result->num_rows == 1) {
                ...
                $database->query("insert into patient(pemail,pname,ppassword, paddress, pDNI,pFNac,ptel) values('$email','$name','$newpassword','$address','$nic','$dob','$tele');");
            ...
            <table border="0" style="width: 69%;">
                ...
                <tr>
                    <td colspan="2">
                        ...
                        <a href="login.php" class="hover-link1 non-style-link">Inicia sesi&oacute;n</a>
                        <br><br><br>
                    </td>
                </tr>
