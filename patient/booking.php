                                            ...
                                            <div  class="dashboard-items search-items"  >
                                                ...
                                                <div style="width:100%">
                                                        ...
                                                        <div class="form-check">
                                                            <label class="form-check-label" for="rbAtencionMedica">Seleccione un tipo de atenci&oacute;n</label>
                                                            <select class="form-select" name="slectTipoAtencion">
                                                                <option value="1">Atenci&oacute;n m&eacute;dica</option>
                                                                <option value="2">Lectuar de resultados</option>
                                                                <option value="3">1º atenci&oacute;n postoperatoria</option>
                                                                <option value="4">2º atenci&oacute;n postoperatoria</option>
                                                                <option value="5">3º atenci&oacute;n postoperatoria</option>
                                                                <option value="6">4º atenci&oacute;n postoperatoria</option>
                                                            </select>
