        ...
        <tr class="menu-row">
            <td class="menu-btn menu-icon-doctor">
                <a href="doctors.php" class="non-style-link-menu">
                    <div>
                        <p class="menu-text">Todos los Médicos</p>
                </a>
    </div>
    </td>
    </tr>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <p>¿No sabes como hacer el proceso? Puedes saltar directamente a la sección de
                                        <a href="doctors.php" class="non-style-link"><b>"Todos los Médicos"</b></a> o verificar la sección de tus
                                    ...
                                    <h3>Puedes buscar tu Médico aquí</h3>
                                    <form action="schedule.php" method="post" style="display: flex">

                                        <input type="search" name="search" class="input-text " placeholder="Busca tu médico aquí" list="doctors" style="width:45%;">&nbsp;&nbsp;
